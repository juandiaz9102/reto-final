...
public class ServiceAttributeValueChangeEvent   {
  ...
  **/
  ...
  public ServiceAttributeValueChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public ServiceAttributeValueChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
