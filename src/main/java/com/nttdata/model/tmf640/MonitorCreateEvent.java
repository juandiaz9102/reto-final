...
public class MonitorCreateEvent   {
  @JsonProperty("event")
  private MonitorCreateEventPayload event = null;
  ...
  public MonitorCreateEvent event(MonitorCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public MonitorCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(MonitorCreateEventPayload event) {
    this.event = event;
  }

  public MonitorCreateEvent eventId(String eventId) {
  ...
  **/
  ...
  public MonitorCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public MonitorCreateEvent eventType(String eventType) {
  ...
  **/
  ...
  public MonitorCreateEvent correlationId(String correlationId) {
  ...
  **/
  ...
  public MonitorCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public MonitorCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public MonitorCreateEvent description(String description) {
  ...
  **/
  ...
  public MonitorCreateEvent priority(String priority) {
  ...
  **/
  ...
  public MonitorCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
